...
const Header = () => {
    ...
    return (
        <View style={{ backgroundColor: '#008', alignItems: 'center', paddingVertical: 10 }}>
            <Text style={{ fontSize: 15, color: '#fff', paddingHorizontal: 15, paddingVertical: 7, backgroundColor: "#008754", borderRadius: 10 }}>
